...
class Generator(nn.Module):
    def __init__(self, ngf=64, nz=100, nc=3, im_size=1024):
        ...
        # Dense frequency expand
        self.feat_32_fre = UpBlockComp(nfc[16], nfc[32])
        self.feat_64_fre = UpBlock(nfc[32], nfc[64])
        self.feat_128_fre = UpBlockComp(nfc[64], nfc[128])

        # Dense frequency connection
        self.dense_connection_1 = nn.Sequential(conv2d(nfc[32], nfc[32] * 2, 3, 1, 1, bias=False),
                                                batchNorm2d(nfc[32] * 2), GLU())
        self.dense_connection_2 = nn.Sequential(conv2d(nfc[64], nfc[64] * 2, 3, 1, 1, bias=False),
                                                batchNorm2d(nfc[64] * 2), GLU())
        self.dense_connection_3 = nn.Sequential(conv2d(nfc[128], nfc[128] * 2, 3, 1, 1, bias=False),
    ...
    def forward(self, input, skips):
        if skips:
            ...
            original_8_to_original_16 = self.feat_32(original_8)
            original_8_to_original_16_to_original_32 = self.feat_64(original_8_to_original_16)
            original_8_to_original_16_to_original_32_to_original_64 = self.feat_128(
                original_8_to_original_16_to_original_32)
            ...
            original_16_to_original_32 = self.feat_64(original_16)
            original_16_to_original_32_original_64 = self.feat_128(original_16_to_original_32)
            ...
            original_32_to_original_64 = self.feat_128(original_32)
            fres_32 = LH_32 + HL_32 + HH_32

            feat_64 = self.se_64(feat_4, self.feat_64(self.dense_connection_1(feat_32 + (original_16 - original_8_to_original_16) + original_16)))
            ...
            feat_128 = self.se_128(feat_8, self.feat_128(self.dense_connection_2(feat_64 + (original_32 - original_8_to_original_16_to_original_32) + (original_32 - original_16_to_original_32) + (original_16_to_original_32 - original_8_to_original_16_to_original_32) + original_32)))

            # feat_256 = self.se_256(feat_16, self.feat_256(feat_128))
            feat_256 = self.se_256(feat_16, self.feat_256(self.dense_connection_3(feat_128 + (original_32_to_original_64 - original_8_to_original_16_to_original_32_to_original_64) + (original_32_to_original_64 - original_16_to_original_32_original_64))))
            # feat_256 = self.se_256(feat_16, self.feat_256(
            #                 self.dense_connection_3(feat_128 + original_8_to_original_16_to_original_32_to_original_64 + original_16_to_original_32_original_64 + original_32_to_original_64 + original_64)))
            ...
            original_8 = self.recon_block4(LL_8, LH_8, HL_8, HH_8)
            original_8 = self.feat_1024_to_256(original_8)
            original_8_to_original_16 = self.feat_32_fre(original_8)
            original_8_to_original_16_to_original_32 = self.feat_64_fre(original_8_to_original_16)
            original_8_to_original_16_to_original_32_to_original_64 = self.feat_128_fre(
                original_8_to_original_16_to_original_32)
            fres_8 = LH_8 + HL_8 + HH_8
            ...
            original_16 = self.recon_block3(LL_16, LH_16, HL_16, HH_16)
            original_16 = self.feat_512_to_128(original_16)
            original_16_to_original_32 = self.feat_64_fre(original_16)
            original_16_to_original_32_original_64 = self.feat_128_fre(original_16_to_original_32)
            ...
            original_32 = self.recon_block2(LL_32, LH_32, HL_32, HH_32)
            original_32 = self.feat_256_to_128(original_32)
            original_32_to_original_64 = self.feat_128_fre(original_32)
            fres_32 = LH_32 + HL_32 + HH_32
            ...
            # feat_256 = self.se_256(feat_16, self.feat_256(feat_128))
            feat_256 = self.se_256(feat_16, self.feat_256(self.dense_connection_3(feat_128 + (original_32_to_original_64 - original_8_to_original_16_to_original_32_to_original_64) + (original_32_to_original_64 - original_16_to_original_32_original_64))))
            # feat_256 = self.se_256(feat_16, self.feat_256(self.dense_connection_3(feat_128 + original_8_to_original_16_to_original_32_to_original_64 + original_16_to_original_32_original_64 + original_32_to_original_64 + original_64)))
...
class Discriminator(nn.Module):
    ...
    def forward(self, imgs, label, part=None):
        ...
        # feat_2_high_frequency = self.down_from_big(Sobel_tran(imgs[0]))
        # feat_4_high_frequency = self.down_4(feat_2_high_frequency)
        # feat_8_high_frequency = self.down_8(feat_4_high_frequency)
        # feat_16_high_frequency = self.down_16(feat_8_high_frequency)
        # feat_16_high_frequency = self.se_2_16(feat_2_high_frequency, feat_16_high_frequency)
        # feat_32_high_frequency = self.down_32(feat_16_high_frequency)
        # feat_32_high_frequency = self.se_4_32(feat_4_high_frequency, feat_32_high_frequency)
        # feat_last_high_frequency = self.down_64(feat_32_high_frequency)
        # feat_last_high_frequency = self.se_8_64(feat_8_high_frequency, feat_last_high_frequency)
        # rf_0_high_frequency = self.rf_big(feat_last_high_frequency).view(-1)
