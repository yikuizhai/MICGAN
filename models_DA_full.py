    ...
    def forward(self, input, skips):
        if skips:
            ...
            feat_64 = self.se_64(feat_4, self.feat_64(
                self.dense_connection_1(feat_32 + original_8_to_original_16 + original_16)))
            ...
            feat_128 = self.se_128(feat_8, self.feat_128(
                self.dense_connection_2(
                    feat_64 + original_8_to_original_16_to_original_32 + original_16_to_original_32 + original_32)))

            # feat_256 = self.se_256(feat_16, self.feat_256(feat_128))
            feat_256 = self.se_256(feat_16, self.feat_256(
                self.dense_connection_3(
                    feat_128 + original_8_to_original_16_to_original_32_to_original_64 + original_16_to_original_32_original_64 + original_32_to_original_64)))
            # feat_256 = self.se_256(feat_16, self.feat_256(
            ...
            # feat_256 = self.se_256(feat_16, self.feat_256(feat_128))
            feat_256 = self.se_256(feat_16, self.feat_256(self.dense_connection_3(
                feat_128 + original_8_to_original_16_to_original_32_to_original_64 + original_16_to_original_32_original_64 + original_32_to_original_64)))
