...
if __name__ == '__main__':
    ...
    parser.add_argument('--path_a', type=str, default='/media/zhihao/F05CC6255CC5E706/dataset/few-shot-image-datasets/few-shot-images/100-shot-obama')
    parser.add_argument('--path_b', type=str, default='/media/zhihao/Drive2ofZhiHao/PytorchPro/Experiment/train_results/AF-Dog_20240204_Concat')
