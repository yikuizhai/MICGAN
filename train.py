...
from models_concat import weights_init, Discriminator, Generator
# from models_SFC_full import weights_init, Discriminator, Generator
# from models_DA_full import weights_init, Discriminator, Generator
...
def train(args):
    ...
    start_ema = 0
    tb_writer = SummaryWriter("./train_results/AF-Dog_20240204_concat/logs")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--path', type=str, default='./datasets/AnimalFace-dog/img', help='path of resource dataset, should be a folder that has one or many sub image folders inside')
    parser.add_argument('--cuda', type=int, default=0, help='index of gpu to use')
    parser.add_argument('--name', type=str, default='AF-Dog_20240204_Concat', help='experiment name')
