...
from models_concat import Generator
# from models_SFC_full import Generator
# from models_DA_full import Generator
...
if __name__ == "__main__":
    ...
    parser.add_argument('--artifacts', type=str, default="train_results/AF-Dog_20240204_Concat", help='path to artifacts.')
    ...
    for epoch in [10000*i for i in range(args.start_iter, args.end_iter+1)]:
        ...
        dist = 'train_results/AF-Dog_20240204_Concat/eval_%d'%(epoch)
