...
class Generator(nn.Module):
    def __init__(self, ngf=64, nz=100, nc=3, im_size=1024):
        ...
        self.dense_connection_1 = nn.Sequential(conv2d(nfc[32] * 3, nfc[32] * 2, 3, 1, 1, bias=False),
                                                batchNorm2d(nfc[32] * 2), GLU())
        self.dense_connection_2 = nn.Sequential(conv2d(nfc[64] * 4, nfc[64] * 2, 3, 1, 1, bias=False),
                                                batchNorm2d(nfc[64] * 2), GLU())
        self.dense_connection_3 = nn.Sequential(conv2d(nfc[128] * 4, nfc[128] * 2, 3, 1, 1, bias=False),
    ...
    def forward(self, input, skips):
        if skips:
            ...
            feat_64 = self.se_64(feat_4, self.feat_64(
                self.dense_connection_1(torch.cat((feat_32, original_8_to_original_16, original_16), dim=1))))
            ...
            feat_128 = self.se_128(feat_8, self.feat_128(self.dense_connection_2(
                torch.cat((feat_64, original_8_to_original_16_to_original_32, original_16_to_original_32, original_32),
                          dim=1))))

            # feat_256 = self.se_256(feat_16, self.feat_256(feat_128))
            feat_256 = self.se_256(feat_16, self.feat_256(self.dense_connection_3(torch.cat((feat_128,
                                                                                             original_8_to_original_16_to_original_32_to_original_64,
                                                                                             original_16_to_original_32_original_64,
                                                                                             original_32_to_original_64),
                                                                                            dim=1))))
            ...
            original_64 = self.recon_block2(LL_64, LH_64, HL_64, HH_64)
            # original_64 = self.feat_256_to_64(original_64)
            feat_128 = self.se_128(feat_8, self.feat_128(self.dense_connection_2(torch.cat((feat_64, original_8_to_original_16_to_original_32, original_16_to_original_32, original_32), dim=1))))

            # feat_256 = self.se_256(feat_16, self.feat_256(feat_128))
            feat_256 = self.se_256(feat_16, self.feat_256(self.dense_connection_3(torch.cat((feat_128, original_8_to_original_16_to_original_32_to_original_64, original_16_to_original_32_original_64, original_32_to_original_64), dim=1))))
            # feat_256 = self.se_256(feat_16, self.feat_256(self.dense_connection_3(feat_128 + original_8_to_original_16_to_original_32_to_original_64 + original_16_to_original_32_original_64 + original_32_to_original_64 + original_64)))
